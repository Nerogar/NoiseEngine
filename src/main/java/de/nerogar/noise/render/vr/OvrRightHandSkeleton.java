...
public class OvrRightHandSkeleton extends Skeleton {
	...
	public static final String BONE_NAME_WRIST             = "wrist_r";
	public static final String BONE_NAME_THUMB_0           = "finger_thumb_0_r";
	public static final String BONE_NAME_THUMB_1           = "finger_thumb_1_r";
	public static final String BONE_NAME_THUMB_2           = "finger_thumb_2_r";
	public static final String BONE_NAME_THUMB_END         = "finger_thumb_r_end";
	public static final String BONE_NAME_INDEX_FINGER_0    = "finger_index_meta_r";
	public static final String BONE_NAME_INDEX_FINGER_1    = "finger_index_0_r";
	public static final String BONE_NAME_INDEX_FINGER_2    = "finger_index_1_r";
	public static final String BONE_NAME_INDEX_FINGER_3    = "finger_index_2_r";
	public static final String BONE_NAME_INDEX_FINGER_END  = "finger_index_r_end";
	public static final String BONE_NAME_MIDDLE_FINGER_0   = "finger_middle_meta_r";
	public static final String BONE_NAME_MIDDLE_FINGER_1   = "finger_middle_0_r";
	public static final String BONE_NAME_MIDDLE_FINGER_2   = "finger_middle_1_r";
	public static final String BONE_NAME_MIDDLE_FINGER_3   = "finger_middle_2_r";
	public static final String BONE_NAME_MIDDLE_FINGER_END = "finger_middle_r_end";
	public static final String BONE_NAME_RING_FINGER_0     = "finger_ring_meta_r";
	public static final String BONE_NAME_RING_FINGER_1     = "finger_ring_0_r";
	public static final String BONE_NAME_RING_FINGER_2     = "finger_ring_1_r";
	public static final String BONE_NAME_RING_FINGER_3     = "finger_ring_2_r";
	public static final String BONE_NAME_RING_FINGER_END   = "finger_ring_r_end";
	public static final String BONE_NAME_PINKY_FINGER_0    = "finger_pinky_meta_r";
	public static final String BONE_NAME_PINKY_FINGER_1    = "finger_pinky_0_r";
	public static final String BONE_NAME_PINKY_FINGER_2    = "finger_pinky_1_r";
	public static final String BONE_NAME_PINKY_FINGER_3    = "finger_pinky_2_r";
	public static final String BONE_NAME_PINKY_FINGER_END  = "finger_pinky_r_end";
	public static final String BONE_NAME_THUMB_AUX         = "finger_thumb_r_aux";
	public static final String BONE_NAME_INDEX_FINGER_AUX  = "finger_index_r_aux";
	public static final String BONE_NAME_MIDDLE_FINGER_AUX = "finger_middle_r_aux";
	public static final String BONE_NAME_RING_FINGER_AUX   = "finger_ring_r_aux";
	public static final String BONE_NAME_PINKY_FINGER_AUX  = "finger_pinky_r_aux";

	public OvrRightHandSkeleton(IReadonlyMatrix4f[] bindPose) {
		super(
				new String[] {
						BONE_NAME_ROOT,
						BONE_NAME_WRIST,
