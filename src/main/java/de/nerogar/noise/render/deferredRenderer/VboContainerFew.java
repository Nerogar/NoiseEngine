...
class VboContainerFew implements VboContainer {

	private DeferredRendererProfiler profiler;
	private DeferredContainer container;
	private Set<DeferredRenderable> renderables;
	...
	public VboContainerFew(DeferredRendererProfiler profiler, DeferredContainer container, Shader gBufferShader) {
